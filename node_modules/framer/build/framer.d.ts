...
declare interface AssetContext {
    size?: number;
    fallback?: string;
}

declare type AssetResolver = (identifier: string, context: AssetContext) => string | undefined;
...
export declare class FramerAnimation<Value, AnimatorOptions> {
     ...
     * @internal
     */
    private get playStateValue();
    /**
     * @internal
     */
    private set playStateValue(value);
    /**
     * @internal
     */
