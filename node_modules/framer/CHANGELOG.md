...
In addition to the changes listed below, this version also updates the bundled Framer Motion library from 1.6.7 to 1.7.3, which includes a bunch of fixes, and a few new features. See [Framer Motion's changelog](https://github.com/framer/motion/blob/master/CHANGELOG.md) for more.
